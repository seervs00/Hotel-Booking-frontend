  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            <p className='text-xs font-inter p-1.5 px-3 tex-white bg-orange-500 rounded-full'>20%OFF</p>
        </div>
        {/* room tating */}
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                ...
                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                    {room.amenities.map((item,index) => (
                        <div key={index}
                        className='flex items-center gap-2 pc-3 py-2 rounded-lg bg-gray-100'
                        >
            ...
            <div>
                <p className='text-2xl font-medium'> ${room.pricePerNight} /neight</p>
            </div>
        </div>
