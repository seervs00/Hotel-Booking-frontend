...
const HotelCard = ({room,index}) => {
    return(
        <Link to ={'/rooms/'+ room.id} onClick={() => scrollTo(0,0)} key={room.id} className=" relative max-w-96  rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_rgba(0,0,0,0.05)]">
          <img src={room.images[0]} alt="room-img "  className="min-w-96  h-64 object-cover " />
          ...
          <div className="p-4 pt-5"> 
            <div className="flex items-center justify-between">
                 ...
                 <div className="flex items-center gsp-1 text-sm">
                    <img src={assets.starIconFilled} alt="star-icon" />4.5
                 </div>
            </div>
            <div className="flex items-center gsp-1 text-sm ">
                <img src={assets.locationFilledIcon} alt="loc-icon" />
